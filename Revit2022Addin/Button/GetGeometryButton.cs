...
{
    internal class GetGeometryButton
    {
        public void Geometry(UIControlledApplication application)
        {
            try
            {
            ...
            PushButtonData testButton = new PushButtonData("GetGeometry", "GetGeometry",
                Assembly.GetExecutingAssembly().Location, "Revit2022Addin.GetGeometry.GetGeometryBinding");
            testButton.ToolTip = "Get Geometry";
            testButton.LongDescription = "Get Geometry";
